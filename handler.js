...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: '_FITUR INI HANYA BISA OLEH USER PREMIUM, JIKA INGIN MEBELI KETIK, *.premium*_',
        group: '_FITUR INI HANYA BISA DI GUNAKAN DI DALAM GRUP, JIKA INGIN MEMBELI KETIK *.sewa*_',
        private: '_FITUR INI DAPAT DI GUNAKAN DI DALAM PRIVATE CHAT_',
        admin: '_HANYA ADMIN SAJA YANG BISA MENGGUNAKAN FITUR INI_',
        botAdmin: '_JADIKAN BOT SEBAGAI ADMIN TERLEBIH DAHULU_',
        onlyprem: '_HANYA USER PREMIUM YG BISA MENGGUNAKAN FITUR INI DI PRIVATE CHAT, JIKA MAU MEMBELI KETIK *.premium*_',
        nsfw: '_ADMIN MENONAKTIFKAN FITUR HENTAI DI GRUP INI_',
        rpg: '_ADMIN MENONAKTIFKAN FITUR RPG DI GROUP INI_',
        game: '_ADMIN MENONAKTIFKAN FITUR GAME DI GRUP INI_',
